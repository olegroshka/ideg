...
commutant search matches every quasiperiodic run at $N{=}10$
essentially exactly (20/20, median $0.0052$, best $10^{-9}$), at the
match quality of the cheap impostors of other classes, and the
integrable class likewise ($0.0077$). Degenerate-block coherence ---
